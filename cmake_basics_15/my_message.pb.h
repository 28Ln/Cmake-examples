...
namespace google {
namespace protobuf {
template<> ::my_package::MyMessage* Arena::CreateMaybeMessage<::my_package::MyMessage>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace my_package {
...
class MyMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:my_package.MyMessage) */ {
 public:
  MyMessage();
  virtual ~MyMessage();
  ...
  // @@protoc_insertion_point(class_scope:my_package.MyMessage)
 private:
...
inline ::google::protobuf::int32 MyMessage::id() const {
  // @@protoc_insertion_point(field_get:my_package.MyMessage.id)
  return id_;
}
inline void MyMessage::set_id(::google::protobuf::int32 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:my_package.MyMessage.id)
}
...
inline const ::std::string& MyMessage::name() const {
  // @@protoc_insertion_point(field_get:my_package.MyMessage.name)
  return name_.GetNoArena();
}
inline void MyMessage::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:my_package.MyMessage.name)
}
#if LANG_CXX11
inline void MyMessage::set_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:my_package.MyMessage.name)
}
#endif
inline void MyMessage::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:my_package.MyMessage.name)
}
inline void MyMessage::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:my_package.MyMessage.name)
}
inline ::std::string* MyMessage::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:my_package.MyMessage.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MyMessage::release_name() {
  // @@protoc_insertion_point(field_release:my_package.MyMessage.name)
...
inline void MyMessage::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:my_package.MyMessage.name)
}
